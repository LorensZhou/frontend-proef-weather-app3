...
function Profile() {
    ...
    // const [invalidCityNames, setInvalidCityNames] = useState({
    //   invalid: false,
    //   invalidCityNameField: "",
    // });
    ...
    const handleSubmit = (event) => {
        ...
        // if (invalidCityNamesCheck(allCities).length > 0) {
        //   setInvalidCityNames(
        //       {
        //         invalid: true,
        //         invalidCityNameField: invalidCityNamesCheck(allCities)[0],
        //       }
        //   )
        // }
    };
    ...
    useEffect(() => {
        ...
        //haal de plaatsnamen op van de localstorage
    ...
    return (
        <>
            ...
            <section className="search-section">
                <form className="search-form-flex" onSubmit={handleSubmit} onClick={handleFormClick}>
                    ...
                    <div className="button-container-flex">
                        ...
                        <button type="button" className="updating-button-flex" onClick={handleCitiesDisabled}>Wijzigen plaatsen</button>
                    </div>
                </form>
                {/*{invalidCityNames.invalid &&*/}
                {/*    <p className="error-message">Ongeldige plaatsnamen: plaats {invalidCityNames.invalidCityNameField}</p>*/}
                {/*}*/}
            </section>

            {/*<button type="button" onClick={handleButtonClicked}>Opslaan in localstorage</button>*/}
