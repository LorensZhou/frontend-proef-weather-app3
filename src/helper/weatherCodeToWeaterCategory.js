...
function weatherCodeToWeatherCategory(weatherCode) {
    ...
    switch (true) { // We evalueren 'true' en vergelijken de cases met booleaanse expressies
        ...
        case indexNum < 5:
            ...
            break;
        case indexNum < 10:
            category = "slecht atmosfeer";
            break;
        case indexNum < 15:
            category = "zeer slecht atmosfeer";
            break;
        case indexNum < 18:
            category = "licht sneeuw";
            break;
        case indexNum < 24:
            category = "gemiddeld sneeuw";
            break;
        case indexNum < 26:
            category = "zwaar sneeuw";
            break;
        case indexNum < 29:
            category = "licht regen";
            break;
        case indexNum < 31:
            category = "middel zwaar regen";
            break;
        case indexNum < 35:
            category = "zwaar regen";
            break;
        case indexNum < 43:
            category = "mot regen";
            break;
